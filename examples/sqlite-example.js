/**
 * SQLite Example - GuruORM
 * 
 * Complete working example with SQLite database
 */
...
capsule.addConnection({
  driver: 'sqlite',
  database: './test.db', // File path or ':memory:' for in-memory database
});
...
// Main function
async function main() {
  console.log('SQLite Connection Test with GuruORM');
  console.log('');

  try {
    // Create tables first
    console.log('Setting up database schema...');
    await capsule.unprepared(`
    ...
    console.log(`   Average age: ${avgAge || 0}`);
