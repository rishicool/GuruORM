/**
 * SQL Server Example - GuruORM
 * 
 * Complete working example with SQL Server database
 */
...
// Main function
async function main() {
  console.log('SQL Server Connection Test with GuruORM');
  console.log('');
  ...
  try {
    ...
    console.log('All SQL Server tests passed successfully!');
